...
import ru.pet.nursery.listener.TelegramBotUpdatesListener;
...
import static ru.pet.nursery.data.Command.START_COMMAND;
...
public class TelegramBotUpdatesListenerTest {
    ...
    private List<Update> getUpdates(String content) throws URISyntaxException, IOException {
        String json = readJsonFromResource( "update.json");
    ...
    void process() throws URISyntaxException, IOException {
        ...
        telegramBotListener.process(getUpdates(START_COMMAND));
